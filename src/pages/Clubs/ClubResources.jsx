  ...
  return (
    <>
      ...
      <div className="club-resources">
        ...
        <p>
          Here you can find all the materials and resources to maintain, or
          start a new club in one place!
        </p>
        <h2>Join the 2025-2026 Activities Google Classroom</h2>
        <p>
          <strong>Join Code:</strong> knmn6yuw
        </p>
        <p>
          ...
          join the google classroom to be able to submit docs, and receive
          important updates
        </p>
        <h2>Main Contact: Enkhiinkhuslen Tegshjargal (SBC Club Coordinator)</h2>
        <p>Email: lowellclubcoord25@gmail.com</p>
        <div className="club-buttons">
          <LinkButton to="/Clubs/NewClub" noTarget={true}>
            How to Start a Club
          </LinkButton>
          <LinkButton to="/Clubs/EventPlanning" noTarget={true}>
            Event Planning Resources
          </LinkButton>
          <LinkButton to="/Clubs/Fundraising" noTarget={true}>
