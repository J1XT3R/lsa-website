  ...
  return (
    <>
      ...
      <section className="info-page">
        ...
        <p>
          <strong>KEEP IN MIND</strong> that there are only resources listed
          here. If you are looking for more information, join the 2023-2024
          Activities Google Classroom (g6sf3ss).
        </p>

        <h2>
          Main Contact:{" "}
          <span style={{ fontWeight: "600" }}>
            Brandon Ho (SBC Events Coordinator)
          </span>
        </h2>
