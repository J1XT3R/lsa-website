  ...
  return (
    <>
      ...
      <section className="info-page">
        ...
        <p>
          Before you can start meetings, you must fill out a couple of forms and
          get them approved by the SBC Club Coordinator. All of these MUST be
          filled out by the deadline. All forms should preferably be signed
        ...
        <p>
          Once you get an EMAIL saying you are CONFIRMED with all your submitted
          forms, you will be sent a spreadsheet with your bulletin board
          assignment. Check the spreadsheet, decorate your bulletin board, then
