  ...
  return (
    <>
      ...
      <div className="title-ix">
        ...
        <p>
          {" "}
          <a href="https://www.sfusd.edu/know-your-rights/sexual-harassment-and-sex-discrimination-title-ix">
        ...
        <p>
          {" "}
          <a href="https://www.sanfranciscopolice.org/get-service/sexual-assault">
          ...
          <span>
            ...
            <li>
              2. <span>Special Victims Unit</span>
            </li>
        ...
        <p>
          {" "}
          <a href="https://sfwar.org/programs-services/advocacy-counseling/">
            San Francisco Women Against Rape (SFWAR)
          </a>
          <span>
            <li>
              2. <span>Advocacy & Counseling Program</span>
            </li>
        ...
        <p>
          Title IX Coordinators: Ms. Liverpool (liverpoolk@sfusd.edu), Ms. Fong
          (fongc3@sfusd.edu)
        </p>
        <a href="https://drive.google.com/file/d/1M2njXNeBJ00dUoiqypqifuSEQu8Uf81t/view">
          SFUSD Title IX Complaint Form <br />→
          https://tinyurl.com/titleixformalcomplaint
        </a>
        <a href="https://drive.google.com/file/d/1mLVM9x8aYIftEUHCQ_blYr6_djKaN5FE/view">
          Lowell Incident Report Form
          <br />→ https://tinyurl.com/lhsincidentreport
        </a>
      </div>
    </>
  );
