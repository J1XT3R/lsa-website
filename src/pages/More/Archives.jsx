    ...
    <>
      ...
      <section className="info-page">
        <p>
          ...
          year in which they served. Photos and other media can be found in each
          board&apos;s respective social media pages, if you&apos;d like the whole event
          album please email lowellhssbc@gmail.com for access to it.
        </p>
        <h2>Coming Soon</h2>
      </section>
    </>
